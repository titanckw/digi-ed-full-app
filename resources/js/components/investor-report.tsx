...
export function InvestorReport() {
    ...
    const techStack = [
        ...
        },
        {
            name: "Real-time AI",
            category: "Moderation",
            description: "Content filtering & user safety",
        },
        {
            name: "WebRTC",
            category: "Video",
        ...
        },
        {
            name: "PostgreSQL",
            category: "Database",
            description: "Scalable relational database",
        },
        {
            name: "Redis",
            category: "Cache",
        ...
        competitorAnalysis: [
            {
                name: "Wyzant",
                marketShare: 15,
                weakness: "Limited safety features",
            },
            { name: "Tutor.com", marketShare: 12, weakness: "High pricing" },
            {
                name: "Chegg Tutors",
                marketShare: 10,
                weakness: "Academic focus only",
            },
            {
                name: "Preply",
                marketShare: 8,
                weakness: "Language learning focus",
            },
        ],
    };
    ...
    const competitiveAdvantages = [
        {
            ...
            description:
                "Industry-leading AI-powered content moderation and parental controls",
        ...
        },
        {
            ...
            description:
                "Unique three-way ecosystem serving students, tutors, and parents",
        ...
        },
        {
            ...
            description:
                "Live session oversight with instant intervention capabilities",
        ...
        },
        {
            ...
            description:
                "Modern tech stack built for global scale and performance",
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
                        The World's Safest Online Tutoring Platform with
                        Advanced AI Moderation and Parental Controls
                    </p>
                ...
                <Card className="mb-12 border-0 shadow-xl">
                    <CardHeader className="bg-gradient-to-r from-primary to-secondary text-white rounded-t-lg">
                        ...
                        <CardDescription className="text-white/90 text-lg">
                            Revolutionizing online education with safety-first
                            approach
                        </CardDescription>
                    </CardHeader>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <div>
                                ...
                                <p className="text-gray-700 mb-4 leading-relaxed">
                                    The global online tutoring market is
                                    experiencing unprecedented growth, driven by
                                    increased demand for personalized education
                                    and safety concerns around traditional
                                    in-person tutoring. DigiEd addresses these
                                    challenges with the industry's most advanced
                                    safety platform.
                                </p>
                                <div className="space-y-3">
                                    <div className="flex items-center">
                                        ...
                                        <span>
                                            $350B global education technology
                                            market
                                        </span>
                                    </div>
                                    <div className="flex items-center">
                                        <CheckCircle className="w-5 h-5 text-accent mr-3" />
                                        <span>
                                            14.7% annual growth rate (2024-2028)
                                        </span>
                                    </div>
                                    <div className="flex items-center">
                                        <CheckCircle className="w-5 h-5 text-accent mr-3" />
                                        <span>
                                            First platform with comprehensive
                                            parent monitoring
                                        </span>
                                    </div>
                                    <div className="flex items-center">
                                        <CheckCircle className="w-5 h-5 text-accent mr-3" />
                                        <span>
                                            AI-powered safety system with 99.8%
                                            accuracy
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-700 mb-4 leading-relaxed">
                                    DigiEd is the world's first tutoring
                                    platform designed with safety as the primary
                                    focus. Our three-stakeholder ecosystem
                                    serves students, tutors, and parents with
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <Card className="border-0 shadow-lg">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <div className="text-3xl font-bold text-blue-600">
                                        ${financialMetrics.averageSessionValue}
                                    </div>
                                    <div className="text-sm text-gray-600">
                                        Avg Session Value
                                    </div>
                            ...
                            <Card className="border-0 shadow-lg">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <div className="text-3xl font-bold text-purple-600">
                                        $
                                        {
                                            financialMetrics.customerAcquisitionCost
                                        }
                                    </div>
                                    <div className="text-sm text-gray-600">
                            ...
                            <Card className="border-0 shadow-lg">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <div className="text-3xl font-bold text-red-600">
                                        ${financialMetrics.lifetimeValue}
                                    </div>
                                    <div className="text-sm text-gray-600">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            ...
                            <Card className="border-0 shadow-lg">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <div className="text-3xl font-bold text-secondary">
                                        {safetyStats.violationsDetected}
                                    </div>
                                    <div className="text-sm text-gray-600">
                                        Violations Detected
                                    </div>
                    ...
                    <TabsContent value="technology" className="space-y-8">
                        <Card className="border-0 shadow-lg">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modern, scalable, and secure technology
                                    stack
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <TabsContent value="market" className="space-y-8">
                            ...
                            <Card className="border-0 shadow-lg">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <div className="text-3xl font-bold text-blue-600">
                                        $
                                        {(
                                            marketData.totalMarket / 1000000000
                                        ).toFixed(0)}
                                        B
                                    </div>
                                    <div className="text-sm text-gray-600">
                            ...
                            <Card className="border-0 shadow-lg">
                                <CardContent className="p-6 text-center">
                                    ...
                                    <div className="text-3xl font-bold text-accent">
                                        $
                                        {(
                                            marketData.onlineTutoringMarket /
                                            1000000000
                                        ).toFixed(0)}
                                        B
                                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <Card className="border-0 shadow-lg">
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        {marketData.competitorAnalysis.map(
                                            (competitor, index) => (
                                                <div
                                                    key={index}
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-4 bg-blue-50 rounded-lg">
                                            ...
                                            <p className="text-sm text-blue-800">
                                                Post-pandemic shift to online
                                                learning has created permanent
                                                demand for digital tutoring
                                                solutions.
                                            </p>
                                        </div>
                                        <div className="p-4 bg-green-50 rounded-lg">
                                            ...
                                            <p className="text-sm text-green-800">
                                                Parents increasingly concerned
                                                about child safety in online
                                                environments, creating demand
                                                for monitored platforms.
                                            </p>
                                        </div>
                                        <div className="p-4 bg-purple-50 rounded-lg">
                                            ...
                                            <p className="text-sm text-purple-800">
                                                ...
                                                emerging markets with growing
                                                middle class and internet
                                                penetration.
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <TabsContent value="projections" className="space-y-8">
                        <Card className="border-0 shadow-lg">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Conservative growth estimates based on
                                    current trajectory
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-6">
                                    {revenueProjections.map(
                                        (projection, index) => (
                                            <div
                                                key={index}
                ...
                <Card className="border-0 shadow-xl bg-gradient-to-r from-primary to-secondary text-white">
                    <CardContent className="p-12 text-center">
                        ...
                        <p className="text-xl mb-8 max-w-3xl mx-auto">
                            Join us in building the world's safest and most
                            effective online tutoring platform. With proven
                            traction, innovative technology, and a massive
                            market opportunity, DigiEd is positioned for
                            explosive growth.
                        </p>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                            <div>
                                ...
                                <p className="text-gray-600 mb-2">
                                    Former educator, 15+ years EdTech
                                </p>
