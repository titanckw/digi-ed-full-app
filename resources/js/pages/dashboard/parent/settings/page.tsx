...
export default function ParentSettingsPage() {
    ...
    const handleSave = () => {
        ...
        if (
            settings.emergencyContacts.some(
                ...
                <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        <Button
                            variant="ghost"
                            size="sm"
                            onClick={() => router.get("/dashboard/parent")}
                        >
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        Configure monitoring, safety, and notification
                        preferences
                    </p>
                </div>
                    ...
                    <TabsContent value="monitoring" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure how you want to monitor your
                                    child's tutoring sessions
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Watch sessions in real-time as they
                                            happen
                                        </p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Get notified about behavior concerns
                                            during sessions
                                        </p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Receive alerts when focus levels
                                            drop significantly
                                        </p>
                                    </div>
                                    <Switch
                    ...
                    <TabsContent value="safety" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure safety features and security
                                    preferences
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Allow tutors to see your child's
                                            overall progress
                                        </p>
                                    </div>
                                    <Switch
                                        checked={
                                            settings.shareProgressWithTutors
                                        }
                                        onCheckedChange={() =>
                                            handleToggle(
                                                "shareProgressWithTutors"
                                            )
                                        }
                                    />
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Let tutors add private notes about
                                            sessions
                                        </p>
                                    </div>
                                    <Switch
                                        checked={settings.allowTutorNotes}
                                        onCheckedChange={() =>
                                            handleToggle("allowTutorNotes")
                                        }
                                    />
                                </div>

                                <div className="space-y-2">
                                    <Label htmlFor="suspiciousAction">
                                        Suspicious Activity Response
                                    </Label>
                                    <Select
                                        value={
                                            settings.suspiciousActivityAction
                                        }
                                        onValueChange={(value) =>
                                            handleSelectChange(
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    <p className="text-sm text-gray-600">
                                        Sessions will be flagged if these words
                                        are detected
                                    </p>
                                </div>
                            </CardContent>
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Immediate notifications for safety
                                            concerns
                                        </p>
                                    </div>
                                    <Switch
                    ...
                    <TabsContent value="controls" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Set limits and restrictions for your child's
                                    tutoring
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Require your approval before booking
                                            with new tutors
                                        </p>
                                    </div>
                                    <Switch
                                        ...
                                        {[
                                            ...
                                            >
                                                <input
                                                    type="checkbox"
                                                    id={subject}
                                                    checked={settings.allowedSubjects.includes(
                                                        subject
                                                    )}
                                                    onChange={(e) => {
                                                        if (e.target.checked) {
                    ...
                    <TabsContent value="emergency" className="space-y-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure emergency contacts and automatic
                                    responses
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
