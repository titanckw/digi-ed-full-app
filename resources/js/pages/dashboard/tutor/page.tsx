    ...
    const recentSessions = [
        {
            ...
            earnings: 45,
            feedback:
                "Dr. Johnson is an excellent tutor! Very patient and knowledgeable.",
        },
        {
            id: 2,
            student: "Emily Davis",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Your teaching performance over time
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div
                                    className="text-center cursor-pointer hover:bg-gray-50 p-2 rounded"
                                    onClick={handleEarningsReport}
                                >
