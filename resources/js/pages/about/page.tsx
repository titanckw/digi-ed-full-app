            ...
            <section className="py-20 px-4">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                        We're on a mission to democratize education by
                        connecting passionate tutors with eager learners
                        worldwide. Every student deserves access to
                        personalized, high-quality education that helps them
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Numbers that reflect our commitment to educational
                            excellence
                        </p>
                    </div>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            We're driven by the belief that education should be
                            accessible, personalized, and transformative. These
            ...
            <section className="py-20 px-4 bg-gradient-to-br from-primary/5 to-secondary/5">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            From a simple idea to a global platform transforming
                            education
                        </p>
                    </div>
            ...
            <section className="py-20 px-4 bg-gradient-to-r from-primary to-secondary">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                        Be part of our mission to make quality education
                        accessible to everyone. Whether you want to learn or
                        teach, we're here to support your journey.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button
                            size="lg"
