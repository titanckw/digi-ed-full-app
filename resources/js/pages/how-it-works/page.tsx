...
export default function HowItWorksPage() {
    ...
    const handleFooterLink = (page: string) => {
        ...
        setTimeout(() => router.get(`/${page}`), 500);
    };
            ...
            <section className="py-20 px-4">
                <div className="container mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Whether you're a student looking to learn or a tutor
                        ready to teach, DigiEd makes it simple to connect,
                        schedule, and succeed. Here's how our platform works for
                        everyone.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Start your learning journey in just four simple
                            steps
                        </p>
                    </div>
            ...
            <section className="py-20 px-4 bg-gradient-to-br from-primary/5 to-secondary/5">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Share your expertise and earn money in four easy
                            steps
                        </p>
                    </div>
            ...
            <section className="py-20 px-4 bg-white">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Bring DigiEd's powerful learning tools into your
                            classroom
                        </p>
                    </div>
                    ...
                    <div className="text-center mt-12">
                        <Button
                            ...
                            onClick={() => router.get("/signup?role=school")}
                        >
            ...
            <section className="py-20 px-4 bg-white">
                <div className="container mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Our platform is designed with safety, quality, and
                            convenience in mind
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-400">
                                Connecting students and tutors for better
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-gray-400">
                                ...
                                <li>
                                    <button
                                        onClick={() =>
                                            handleFooterLink("tutor-resources")
                                        }
                                        className="hover:text-white transition-colors text-left"
                                    >
                                        Resources
