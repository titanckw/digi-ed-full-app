...
export default function SignupPage() {
    ...
    const handleStudentSubmit = (e: React.FormEvent) => {
        ...
        router.post("/register", {
            ...
            password_confirmation: studentForm.password, // Assuming no separate confirmation field for simplicity
            role: "student",
            ...studentForm,
        });
    };
    ...
    const handleTutorSubmit = (e: React.FormEvent) => {
        ...
        router.post("/register", {
            name: `${tutorForm.firstName} ${tutorForm.lastName}`,
            email: tutorForm.email,
            password: tutorForm.password,
            password_confirmation: tutorForm.password,
            role: "tutor",
            ...tutorForm,
        });
    };
    ...
    const handleSchoolSubmit = (e: React.FormEvent) => {
        ...
        // Validate form
        const errors = [];
        if (!schoolForm.teacherName.trim())
        ...
        router.post("/register", {
            name: schoolForm.teacherName,
            email: schoolForm.email,
            password: schoolForm.password,
            password_confirmation: schoolForm.password,
            role: "school",
            ...schoolForm,
        });
    };
                    ...
                    <CardContent>
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                <SelectItem value="1-20">
                                                    1-20 students
                                                </SelectItem>
                                                <SelectItem value="21-40">
                                                    21-40 students
                                                </SelectItem>
                                                <SelectItem value="41-60">
                                                    41-60 students
                                                </SelectItem>
                                                <SelectItem value="60+">
                                                    60+ students
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-gray-600">
                                ...
                                <button
                                    onClick={() =>
                                        router.get(`/login?role=${userType}`)
                                    }
